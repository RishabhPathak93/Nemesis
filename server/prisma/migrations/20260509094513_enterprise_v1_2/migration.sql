...
-- AlterTable
ALTER TABLE "Org" ADD COLUMN     "mfaEnforcedAt" TIMESTAMP(3),
ADD COLUMN     "requireMfa" BOOLEAN NOT NULL DEFAULT false;

-- AlterTable
ALTER TABLE "Report" ADD COLUMN     "shareCreatedById" TEXT,
ADD COLUMN     "shareEnabled" BOOLEAN NOT NULL DEFAULT true,
...
-- CreateIndex
CREATE INDEX "ReportShareView_reportId_viewedAt_idx" ON "ReportShareView"("reportId", "viewedAt");
...
-- AddForeignKey
ALTER TABLE "Report" ADD CONSTRAINT "Report_shareCreatedById_fkey" FOREIGN KEY ("shareCreatedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ReportShareView" ADD CONSTRAINT "ReportShareView_reportId_fkey" FOREIGN KEY ("reportId") REFERENCES "Report"("id") ON DELETE CASCADE ON UPDATE CASCADE;
