 ...
 *   2. Process-level `SMTP_*` env vars — fallback for single-tenant deploys.
 *   3. No transport → log the message for dev visibility, drop the send.
 *
